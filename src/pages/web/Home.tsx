...
import Ansari from "@/assets/web/barbers/ansari.webp";
...
import AnsariGallery from "@/assets/web/barbers/barbers-gallery/ansari.webp";
...
export default function Home() {
  ...
  const barberSvgs = [
    ...
    {
      svg: Ansari,
      thumbnail: AnsariGallery,
      link: generateRoute("/ansari"),
      landing: true,
      slug: "ansari",
    },
